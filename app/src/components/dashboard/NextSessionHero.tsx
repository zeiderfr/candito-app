      ...
      <div className={cn(
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button
            ...
            <div className="size-9 rounded-xl bg-white/5 flex items-center justify-center text-sky-400/50 group-hover:text-accent group-hover:bg-accent/10 transition-all shrink-0">
              <Coffee size={16} />
            </div>

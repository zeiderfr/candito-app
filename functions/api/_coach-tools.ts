/**
 * Coach AI Tool Declarations — JSON pur (aucune dépendance SDK)
 * 
 * Ces déclarations sont utilisées par le Worker Cloudflare pour configurer
 * les function calls de Gemini. Elles n'utilisent PAS les types de
 * @google/generative-ai afin d'éviter d'embarquer le SDK côté client.
 */
